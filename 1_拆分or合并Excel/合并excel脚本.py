...
# 指定要合并excel的路径
src_path = 'F:/Python_study/python_productivity-main/python_productivity-main/文章1代码/文章1代码/调查问卷'
# 指定合并完成的路径
dst_file = 'F:/Python_study/python_productivity-main/python_productivity-main/文章1代码/文章1代码/result/结果.xls'
